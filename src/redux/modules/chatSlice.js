...
export const __createChatRoom = createAsyncThunk("createChatRoom", async (payload, thunkAPI) => {
	try {
...
export const __getChatHistory = createAsyncThunk("getChatHistory", async (payload, thunkAPI) => {
	try {
