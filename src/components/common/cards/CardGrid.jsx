...
import { CardGridContainer, Cards, Card, ImgWrapper, Content, CardInfo } from "./CardGrid.styled";
		...
		<CardGridContainer>
			<Cards gridColumn={gridColumn}>
				...
				{userEnroll?.map(item => {
					const dDay = getDateDiff(item.dueDay, today);
					return (
						<Card key={item.boardId} onClick={() => navigate(`/boards/${item.boardId}`)}>
							<ImgWrapper>
